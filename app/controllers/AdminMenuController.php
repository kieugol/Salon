...
class AdminMenuController extends \BaseController {
	...
	public function getAdd() {
		$menu = new Menu();
		$data['menu_type'] = Config::get('site.menu_type');
		$this->layout->content = View::make('admin.content_right.menu.add', $data);
	}
	// insert articles new
	public function postInsert() {
		$menu = new Menu();
		$data = array(
			'title_menus' => trim(Input::get('txt_name')),
			'alias_menus' => $this->getAlias(trim(Input::get('txt_name'))),
			...
			// 'title_en_menus'=>Input::get('txt_name_en'),
			// 'alias_en_menus' => $this->getAlias(Input::get('txt_name_en')),
			// 'des_en_menus'=>Input::get('txt_des_en'),
		);
	...
	public function getUpdate() {
		$id = Input::get('ID');
		$menu = new Menu();
		$_data['menu_type'] = Config::get('site.menu_type');
