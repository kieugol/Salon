...
<aside class="right-side">
     <form  id="adminForm" method="post"  action="<?php echo Asset('/')?>administrator/user/insert" accept-charset="utf-8" role="form"   >             
            <!-- Content Header (Page header) -->
            <section class="content-header">
                <h1>Users<small>/ insert</small></h1>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                    <div class="box-body">
                                        <table class="table " >
                                            <tr >
                                                <td colspan="2" > <h3>Info Account</h3></td>
                                            </tr>
                                            <tr>
                                                <td width="200"><label>Username/Account</label></td>
                                                <td><input type="text" class="form-control" name="txt_account" id="txt_account" placeholder="Enter username"> </td>
                                            </tr>
                                            <tr>
                                                <td><label>password</label></td>
                                                <td><input type="text" class="form-control" name="txt_pass" id="txt_pass" placeholder="Enter pass" /> </td>
                                            </tr>
                                            <tr>
                                                <td><label>Password again </label></td>
                                                <td><input type="password" class="form-control" name="txt_passagain" id="txt_passagain" placeholder="Enter pass"> </td>
                                            </tr>
                                             <tr>
                                                ...
                                                ?>
                                                        <option  value="<?php echo $result->idUserGroup ?>"><?php echo $result->name?></option>
                                                <?php
                                                     }
                                                ?>
                                                    </select>
                                            ...
                                            <tr>
                                                <td><label>select salon</label></td>
                                                <td>
                                             ...
                                             <tr >
                                                <td colspan="2"> <h3>Info About User </h3></td>
                                            </tr>
                                            <tr>
                                                <td><label>Full Name </label></td>
                                                <td><input type="text" class="form-control" name="txt_name" id="txt_name" placeholder="Full Name"> </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" name="txt_phone" id="txt_phone" placeholder="Enter Phone"> </td>
                                            </tr>
                                             <tr>
                                                <td><label>Address User</label></td>
                                                <td><input type="text" class="form-control" name="txt_address" id="txt_address" placeholder="Enter Address"> </td>
                                            </tr>
                                            <tr>
