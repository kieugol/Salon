...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/') ?>administrator/district/insert" accept-charset="utf-8" role="form"   >
        <!-- Content Header (Page header) -->
        <section class="content-header">
            <h1>district<small>/ insert</small></h1>
                                            ...
                                            <td>
                                                <select class="form-control" id="sl_province" name="sl_province">
                                                    @foreach($list_province as $result)
                                                        <option value="{{$result->id_province}}">{{$result->name_province}}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="200"><label >Tên Quận/ Huyện</label></td>
