...
<aside class="right-side">
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/productsManufacture/update"  accept-charset="uft8" role="form">
    <section class="content-header">
                    <h1>Products Manufacture<small>/ update</small></h1>
                    <div style="text-align: right">
                        <button class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>
                        <a href="<?php echo Asset('/') ?>administrator/productsManufacture/home" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i>Back</a>
                    </div> 
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">                             
                            <div class="box-body">
                                <table class="table " >
                                    <tr >
                                        <td ><label >Product Manufacture Name</label></td>
                                        <td><input type="text" value="<?php echo $list_productsMf['name_products_manufacture'] ?>" class="form-control" name="txt_name"id="txt_name" placeholder="Enter name">
                                             <input type="hidden" name="txt_id" value="<?php echo $list_productsMf['idProductsManufacture'] ?>" />   
                                        </td>                                                                                                       
                                    </tr>
                                    <tr>
                                        <td> <label >Status</label></td>
                                        <td>
                                            <input type="radio" name="rd_status" <?php if($list_productsMf['enable_products_manufacture'] == 1) echo 'checked="checked"'?>   value="1">&nbsp;On &nbsp;&nbsp;     
                                            <input type="radio" name="rd_status" <?php if($list_productsMf['enable_products_manufacture'] == 0) echo 'checked="checked"'?>  value="0"> Off
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> <label >Sort </label></td>
                                        <td> <input type="text" value="<?php echo $list_productsMf['ordering_products_manufacture'] ?>" class="form-control" name="txt_sort" id="txt_sort"> </td>
                                    </tr>
                                    <tr>
                                        <td> <label> Description</label></td>
                                        <td> <textarea name="txt_des" id="txt_des"><?php echo $list_productsMf['des_products_manufacture'] ?></textarea></td>
                                    </tr>
                                    <tr>
                                        <td> <label >Meta title</label></td>
                                        <td><input type="text" value="<?php echo $list_productsMf['meta_title_products_manufacture'] ?>" class="form-control" id="txt_title" name="txt_title" ></td>
                                    </tr>
                                    <tr>
                                        <td> <label >Meta keyword</label></td>
                                        <td><input type="text" value="<?php echo $list_productsMf['meta_key_products_manufacture'] ?>" class="form-control" id="txt_key" name="txt_key" ></td>
                                    </tr>
                                    <tr>
                                        <td> <label>Meta Description</label></td>
                                        <td><input type="text" value="<?php echo $list_productsMf['meta_desc_products_manufacture'] ?>" class="form-control" id="txt_sedesc" name="txt_seodesc" ></td>
                                    </tr>                                
                                </table>
                            </div>                  
                        </div><!-- /.tab-pane -->
