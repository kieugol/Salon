...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/')?>administrator/projectsCategories/insert" accept-charset="utf-8" role="form"   >             
                <!-- Content Header (Page header) -->
                <section class="content-header">             
                    <h1>Projects Categories<small>/ insert</small></h1>
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <div class="box-body">
                                            <table class="table " >
                                                ...
                                                <tr>
                                                    <td><label >Projects Categories Name</label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach($list_menus as $menu)
                                                            <option value="{{$menu->idMenus}}">{{$menu->title_menus}}</option>
                                                        @endforeach
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="sl_parent" id="sl_parent" class="form-control">
                                                        <option selected="selected" value="0">Categories root</option>
                                                        {{$combobox_menu;}}
                                                        </select>
                                                    </td>
                                                </tr>
