...
<aside class="right-side">
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/productsMade/update"  accept-charset="uft8" role="form">
    <section class="content-header">
                    <h1>Products Made in<small>/ update</small></h1>
                    <div style="text-align: right">
                        <button class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>
                        <a href="<?php echo Asset('/') ?>administrator/productsMade/home" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i>Back</a>
                    </div> 
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">                             
                            <div class="box-body">
                                <table class="table " >
                                    <tr >
                                        <td  ><label >Product Made Name</label></td>
                                        <td><input type="text" value="<?php echo $list_productsMade['name_products_madein'] ?>" class="form-control" name="txt_name"id="txt_name" placeholder="Enter name">
                                             <input type="hidden" name="txt_id" value="<?php echo $list_productsMade['idProductsMadein'] ?>" />   
                                        </td>                                                                                                       
                                    </tr>
                                    <tr>
                                        <td> <label >Status</label></td>
                                        <td>
                                            <input type="radio" name="rd_status" <?php if($list_productsMade['enable_products_madein'] == 1) echo 'checked="checked"'?>   value="1">&nbsp;On &nbsp;&nbsp;     
                                            <input type="radio" name="rd_status" <?php if($list_productsMade['enable_products_madein'] == 0) echo 'checked="checked"'?>  value="0"> Off
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> <label >Sort </label></td>
                                        <td> <input type="text" value="<?php echo $list_productsMade['ordering_products_madein'] ?>" class="form-control" name="txt_sort" id="txt_sort"> </td>
                                    </tr>
                                    <tr>
                                        <td> <label> Description</label></td>
                                        <td> <textarea name="txt_des" id="txt_des"><?php echo $list_productsMade['des_products_madein'] ?></textarea></td>
                                    </tr>
