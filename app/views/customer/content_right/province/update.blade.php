...
<aside class="right-side">
 <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/province/update"  accept-charset="uft8" role="form">
    <section class="content-header">
        <h1>province<small>/ update</small></h1>
        <div style="text-align: right">
            <button class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>
            <a href="<?php echo Asset('/') ?>administrator/province/home" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i>Back</a>
        </div>
                        ...
                        <div class="box-body">
                            <table class="table " >
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" value="{{$list_province['name_province']}}"  name="txt_name" id="txt_name" placeholder="Enter title">
                                        <input type="hidden" id="txt_id" name="txt_id" value="<?php echo $list_province['id_province'] ?>" >
                                    </td>
                                </tr>
                            </table>
                        </div>
