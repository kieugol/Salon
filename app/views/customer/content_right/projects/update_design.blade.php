...
<aside class="right-side">
   ...
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/projects/update-design"  accept-charset="uft8" role="form">
    ...
    <section class="content-header">
                    ...
                    <h1>Design<small>/ update</small></h1>
                    ...
                    <div style="text-align: right">
                        ...
                        <a href="<?php echo Asset('/') ?>administrator/projects/design" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i>Back</a>
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select class="form-control" id="sl_parentid" name="sl_parentid">
