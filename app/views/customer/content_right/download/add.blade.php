...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/')?>administrator/download/insert" accept-charset="utf-8" role="form"   >             
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">
                                                ...
                                                <table class="table " >
                                                        <tr>
                                                            <td width="100"><label >Title</label></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @foreach($list_downloadcat as $result)
                                                                    <option value="{{$result->idDownloadCategories}}">{{$result->name_download_categories}}</option>
                                                                @endforeach
                                                                </select>  
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td><input type="text" class="form-control"  name="txt_sort" id="txt_sort" placeholder="Enter Sort"></td>                                                
                                                        </tr>
                                                        <tr>
...
<script type="text/javascript">
        ...
        $("#sl_ordering" ).change(function () {
            var order = $('#sl_ordering').val();
            if(order==2 || order==4 ){
                $('#txt_text3').attr("disabled","disabled");
            }
            else{
                $("#txt_text3").removeAttr('disabled');
            }
        });
</script>
<script type="text/javascript">
