...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/') ?>administrator/salon/insert" accept-charset="utf-8" role="form"   >
                ...
                <div class="  col-md-12 col-lg-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li class=""><a href="#tab_3" data-toggle="tab">Gallery salon</a></li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <table class="table " >
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="txt_banner" id="txt_banner" placeholder="Enter banner"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <option value="0">Chọn quận/huyện</option>
                                                    @foreach($list_district as $district)
                                                        <option value="{{$district->id_district}}">{{$district->name_district }}({{$district->name_province}})</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td> <textarea name="txt_price" id="txt_short_des" rows="5"></textarea></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td> <textarea name="txt_address" class="form-control"  id="txt_address" rows="2"></textarea></td>
                                        </tr>
                                        <tr>
                                            <td> <label>Liên hệ</label></td>
                                            <td> <textarea name="txt_contact" id="txt_des"></textarea></td>
                                        </tr>
                                        <tr>
                                            <td> <label >Maps</label></td>
                                            <td>
                                                <textarea name="txt_maps" class="form-control" id="txt_maps"></textarea>
                                            </td>
                                        </tr>
                                </table>
                                </div>
