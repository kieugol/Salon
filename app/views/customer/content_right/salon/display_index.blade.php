...
@section('content')
 <aside class="right-side">
    <form  id="productForm" method="post"  action="<?php echo Asset('/') ?>administrator/salon/action-index" accept-charset="utf-8" role="form" >
    <section class="content-header">
                    <h1>Hiển thị salon trên trang chủ<small>/ home</small></h1>
                    <div class="text-right">
                        <a href="<?php echo Asset('/') ?>administrator/salon/display-index" class="btn btn-default  btn-flat"><span class="glyphicon glyphicon-refresh"></span></a>
                        <a href="<?php echo Asset('/') ?>administrator/salon/add-index " class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-plus-sign"></span> Add New</a>
                    ...
                    <div class="box-body table-responsive">
                        <table id="tb_home" class="table table-bordered table-striped">
                            ...
                            @foreach ($list_salon as $result)
                                <tr>
                                    <td><input type="checkbox" name="delete[]" value="<?php echo $result->id_salon_index ?>" class="form-control" /></td>
                                    <td>
                                        <input type="text" name="ordering[]" value="{{$result->ordering_salon_index}}" class="form-control" style="width:50px !important" />
                                        <input type="hidden" name="idhide[]" value="{{$result->id_salon}}" />
                                    </td>
