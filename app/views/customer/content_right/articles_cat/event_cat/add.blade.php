...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/') ?>administrator/eventCat/insert" accept-charset="utf-8" role="form"   >
                ...
                <section class="content-header">
                    ...
                    <div style="text-align: right">
                        ...
                        <a href="<?php echo Asset('/') ?>administrator/eventCat/home" class="btn btn-default btn-flat"><i class="fa fa-fw fa-mail-reply"></i> Back</a>
                    </div>
                </section>
