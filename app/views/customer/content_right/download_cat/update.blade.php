...
<aside class="right-side">
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/downloadCategories/update"  accept-charset="uft8" role="form">
    <section class="content-header">
                    <h1>Download Categories<small>/ update</small></h1>
                    <div class="text-right">
                        <button class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>
                        <a href="<?php echo Asset('/') ?>administrator/downloadCategories/home" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i>Back</a>
                    </div> 
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">                
                                            ...
                                            <!-- form start -->                
                                                ...
                                                <table class="table " >
                                                        <tr>
                                                            <td><label>Name Download Categories</label></td>
                                                            <td>
                                                                <input type="text" value="{{$list_downloadcat['name_download_categories']}}" class="form-control"  name="txt_title" id="txt_title" placeholder="Enter Name" />
                                                                <input type="hidden" id="txt_id" name="txt_id" value="<?php echo $list_downloadcat['idDownloadCategories'] ?>" >
                                                            </td> 
                                                        </tr>     
                                                        <tr>                                   
                                                            <td><label >Description</label></td>
                                                            <td><textarea  name="txt_des" id="txt_des">{{$list_downloadcat['des_download_categories']}}</textarea></td>                                                
                                                        </tr>
                                                         <tr>
                                                            <td><label >Sort</label></td>
                                                            <td><input type="text" class="form-control" value="{{$list_downloadcat['ordering_download_categories']}}"  name="txt_sort" id="txt_sort" placeholder="Enter Sort"></td>                                                
                                                        </tr>
                                                        <tr>
                                                            <td> <label >Status</label></td>
                                                            <td>
                                                                <input type="radio" name="rd_status" <?php if($list_downloadcat['enable_download_categories'] == 1) echo 'checked="checked"'?>   value="1">&nbsp;On &nbsp;&nbsp;     
                                                                <input type="radio" name="rd_status" <?php if($list_downloadcat['enable_download_categories'] == 0) echo 'checked="checked"'?>  value="0"> Off
                                                            </td>
                                                        </tr>
                                                </table>
                                                </div>    
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function(e) {
     ...
     // choose images avatar downloadCategories
