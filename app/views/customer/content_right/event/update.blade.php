                                    ...
                                    <table class="table " >
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" id="txt_thumb" name="txt_thumb" value="{{$event_details['thumb_event']}}" class="form-control" >
...
?> value="{{$salon->id_salon}}">{{$salon->name_salon}}({{$salon->name_province}})</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="content_service" style="width:556px">
                                                    ...
                                                    <label>{{$service->name_service . '(' . $service->price_service . ')'}}&nbsp;&nbsp;
                                                    <input type="checkbox" name="service[]" checked="checked" value="{{$service->id_service}}" class=""></label>&nbsp;&nbsp;
                                                    @endforeach
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" value="{{$event_details['percent_event']}}" name="txt_percent" id="txt_percent"></td>
                                        </tr>
                                        <tr>
                                            <td><label>Giá chiết khấu</label></td>
                                            <td><input type="text" class="form-control" value="{{$event_details['price_sale_event']}}" name="txt_sale_price" id="txt_sale_price"></td>
                                        </tr>
                                        <tr>
...
?> value="{{$eventcat->id_event_categories}}">{{$eventcat->name_event_categories}}</option>
                                        ...
                                        <tr>
                                            ...
                                            <td> <textarea name="txt_sort_des" id="txt_sort_des">{{$event_details['short_desc_event']}}</textarea></td>
                                        </tr>
                                        <tr>
...
<script type="text/javascript">
            jQuery(function() {
                ...
                var service = [];
    @foreach($list_service_init as $key => $value)
    service[<?php echo $key ?>] = '{{$value}}';
    @endforeach
