...
<aside class="right-side">
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/media/update-stackholder"  accept-charset="uft8" role="form">
    <section class="content-header">
                    <h1> Stackholder Gallery</h1>
                    <div style="text-align: right">
                    <a href="<?php echo Asset('/') ?>administrator/media/stackholder" class="btn btn-default btn-flat" style="padding-left: 20px; padding-right:20px;"><span class="glyphicon glyphicon-refresh"></span> </a>
                                ...
                                <ul class="img-list">
                                    @foreach ($list_stack as $value)
                                        <li>
                                            ...
                                            <input type="checkbox" checked="checked" name="imglist[]" value="<?php echo $value->id ?>" />                                                 
                                            <br/>
                                            <input type="text" name="url[]" value="{{$value->url}}" style="color:#383535" title="{{$value->url}}" />
                                    ...
                                    @foreach ($list_images as $value)
                                        <li>
                                            ...
                                            <br/>
                                            <input type="text" name="url[]" value="" style="color:#383535" />
                                            <input type="hidden" name="idhide[]" value="{{$value->id}}"/>
                                        </li>
                                    @endforeach
                                </ul>
