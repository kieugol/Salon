...
@section('content')
 <aside class="right-side">
      <form  id="productForm" method="post" accept-charset="utf-8" role="form" action="<?php echo Asset('/')?>administrator/menu/insert-footer"  >             
    <section class="content-header">
        <h1>Menu Footer<small>/ Add</small></h1>
        <div style="text-align: right">
            <button type="submit" class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-plus-sign"></span> Add</button>
            <a href="<?php echo Asset('/') ?>administrator/menu/add-footer " class="btn btn-default  btn-flat"><span class="glyphicon glyphicon-refresh"></span></a>
             <a href="<?php echo Asset('/') ?>administrator/menu/footer "  class="btn btn-danger btn-flat"><span class="glyphicon glyphicon-minus-sign"></span> Back</a>
        </div>  
                    ...
                    <div class="box-body table-responsive">
                        <table id="tb_home" class="table table-bordered table-striped">
                            ...
                            @foreach ($list_menu as $result)
                                <tr>
                                    <td width="50"><input type="checkbox" name="list_footer[]" value="<?php echo $result->idMenus ?>" /></td>
