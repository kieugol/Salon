  ...
  <div class="cp_main">
    ...
    <section class="cp_gallery-section pd-tb80">
      ...
      <div class="container">
        ...
        <div class="cp-heding-style1"><h2>Hệ thống salon tóc {{$district->name_province}}</h2></div>

        <div class="cp_portfolioFilter">

          <a href="#" data-filter="*" class="current">{{$district->name_district}}</a>
