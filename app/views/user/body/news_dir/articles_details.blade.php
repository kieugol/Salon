					...
					<div class="cp-blog-outer">
						...
						<div class="cp-blog-box">
							...
							<ul class="cp_meta-listed">
								<li><i class="fa fa-user"></i> <a href="#">{{$articles_details['related_articles']}}</a></li>
								<li><i class="fa fa-tag"></i> <span>{{$articles_details['name_articles_categories']}}</span></li>
								<li><i class="fa fa-calendar"></i> <span>{{date_format($articles_details['created_at'],'j F Y')}}</span></li>
							</ul>
