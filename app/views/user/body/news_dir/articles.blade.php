           ...
           <div class="cp-blog-outer">
                ...
                <div class="cp-blog-box">
                    ...
                    <ul class="cp_meta-listed">
                        ...
                        <li><i class="fa fa-tag"></i> <span>{{$articles->name_articles_categories}}</span></li>
                    ...
                    <div class="bottom-holder">
                        ...
                        <a href="{{Asset('/tin-tuc').'/'.$articles->alias_articles_categories.'/'.$articles->alias_articles.'/'.$articles->idArticles}}.html" class="cp-btn-style1">Đọc tiếp</a>
                    </div>
                </div>
                @endforeach
                <!--  -->
            ...
            <aside class="cp_sidebar">
              <div class="cp-sidebar-box">
                ...
                <ul class="cp-sidebar-format">
                 @foreach($listArticlesOther as $articles)
                    <li>
                    <div class="holder">
