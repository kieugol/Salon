 ...
 <aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div style="text-align: right">
            ...
            <a href="<?php echo Asset('/') ?>administrator/menu/add-cat " class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-plus-sign"></span> Add from articles categories</a>
                                ...
                                <?php
                                        ...
                                        ?>  
                                            <tr>
                                                ...
                                                <td><?php echo $result->title_menus ?></td>
                                                <td>
                                                   
                                                        {{$result->default_menus;}}
