...
<aside class="right-side">
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/eventCat/update"  accept-charset="uft8" role="form">
    <section class="content-header">
                    <h1>Danh mục sự kiện<small>/ update</small></h1>
                    <div style="text-align: right">
                        <button class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>
                        <a href="<?php echo Asset('/') ?>administrator/eventCat/home" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i>Back</a>
                    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <div class="box-body">
                                <table class="table">
                                    <tr>
                                        <td><label >Danh mục sự kiện</label></td>
                                        <td>
                                            <input type="text" value="{{$list_eventCat->name_event_categories}}" class="form-control" name="txt_name" id="txt_name" placeholder="Enter name">
                                            <input type="hidden" value="{{$list_eventCat->id_event_categories}}" name="txt_id" id="txt_id" >
...
<!--                                 <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td> <input type="text" value="{{$list_eventCat->ordering_event_categories}}" class="form-control" name="txt_sort" id="txt_sort"> </td>
                                    </tr>
                                    <tr>
                                        <td> <label>Mô tả</label></td>
                                        <td> <textarea name="txt_des" id="txt_des">{{$list_eventCat->des_event_categories}}</textarea></td>
                                    </tr>
                                </table>
                            </div>
                        </div><!-- /.tab-pane -->
