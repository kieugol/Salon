...
<aside class="right-side">
     <form  id="productForm" method="post" accept-charset="utf-8" role="form" action="<?php echo Asset('/')?>administrator/articlesCategories/insert"  >             
        <!-- Content Header (Page header) -->
        <section class="content-header">
            <h1>Articles Categories<small>/ insert</small></h1>
