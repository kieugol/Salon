...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/') ?>administrator/province/insert" accept-charset="utf-8" role="form"   >
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <div class="box-body">
                                    <table class="table " >
                                        <tr>
                                            <td width="200"><label >Tên tỉnh/ thành</label></td>
