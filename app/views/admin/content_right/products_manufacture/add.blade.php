...
<aside class="right-side">
     ...
     <form  id="productForm" method="post"  action="<?php echo Asset('/')?>administrator/productsManufacture/insert" accept-charset="utf-8" role="form"   >             

                <!-- Content Header (Page header) -->

                <section class="content-header">             

                    <h1>Products Manufacture<small>/ insert</small></h1>
