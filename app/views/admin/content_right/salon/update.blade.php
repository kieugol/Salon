...
<aside class="right-side">
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/salon/update"  accept-charset="uft8" role="form">
    <section class="content-header">
	<?php $home_url =  $list_salon['auto_register_salon'] ? 'home-auto-register' : 'home';?>
                    <h1>salon<small>/ update</small></h1>
                    <div style="text-align: right">
                        <button class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>
                        <a href="<?php echo Asset('/') ?>administrator/salon/{{$home_url}}" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i>Back</a>
                    </div>
                                        ...
                                        <table class="table " >
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img id="img-data" src="<?php echo Asset('/') . 'store/upload/images/' . $list_salon['thumb_salon'] ?>">
                                                    </a> <br />
                                                    <a href="#" id="img-product"  data-toggle="modal" data-target=".gallery-img"> Changes images</a>
                                                    <input type="hidden" id="txt_thumb" name="txt_thumb" value="<?php echo $list_salon['thumb_salon'] ?>"  >
                                                    <input type="hidden" id="txt_id" name="txt_id" value="<?php echo $list_salon['id_salon'] ?>" >
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><label >banner salon</label></td>
                                                <td><input type="text" class="form-control" value="{{$list_salon['banner_salon']}}" name="txt_banner" id="txt_banner" placeholder="Enter banner"></td>
                                            </tr>
                                            <tr>
                                                <td><label >Tên salon</label></td>
                                                <td><input type="text" value="{{$list_salon['name_salon']}}" class="form-control" name="txt_name"id="txt_name" placeholder="Enter name"></td>

                                            </tr>
                                             <tr>
                                                <td><label >Thuộc Quận/huyện</label></td>
                                                <td>
                                                    <select class="form-control" id="sl_district" name="sl_district">
                                                    <option value="0">Chọn quận/huyện</option>
                                                        @foreach($list_district as $district)
                                                            <option <?php if ($list_salon['id_district'] == $district->id_district) {echo 'selected';}?> value="{{$district->id_district}}">{{$district->name_district }}({{$district->name_province}})</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            </tr>
                                             <tr>
                                                ...
                                                <td> <textarea name="txt_price" id="txt_short_des" rows="5">{{$list_salon['price_salon']}}</textarea></td>
                                            </tr>
                                        <tr>
                                            <td><label>Số điện thoại</label></td>
                                            <td><input type="text" value="{{$list_salon['phone_salon']}}" class="form-control" name="txt_phone" id="txt_phone" placeholder="Enter phone"></td>
                                        </tr>
                                            <tr>
                                                <td> <label>Địa chỉ</label></td>
                                                <td> <textarea name="txt_address" class="form-control" id="txt_address" rows="2">{{$list_salon['address_salon']}}</textarea></td>
                                            </tr>
                                            <tr>
                                                <td> <label>Liên hệ</label></td>
                                                <td> <textarea name="txt_contact" id="txt_des">{{$list_salon['contact_salon']}}</textarea></td>
                                            </tr>
                                            <tr>
                                                <td> <label >Maps</label></td>
                                                <td>
                                                    <textarea name="txt_maps" class="form-control" id="txt_maps">{{$list_salon['maps_salon']}}</textarea>
                                                </td>
                                            </tr>
