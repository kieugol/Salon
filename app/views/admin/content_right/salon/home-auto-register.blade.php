...
@section('content')
 <aside class="right-side">
    ...
    <section class="content-header">
                    <h1>Salon chờ duyệt<small>/ home</small></h1>
                    <div style="text-align: right">
                        <a href="<?php echo Asset('/') ?>administrator/salon/home-auto-register" class="btn btn-default  btn-flat"><span class="glyphicon glyphicon-refresh"></span></a>
                    ...
                    <div class="box-body table-responsive">
                        <table id="tb_home" class="table table-bordered table-striped">
                            ...
                            @foreach ($list_salon as $result)
                                <tr>
                                    <td><input type="checkbox" name="delete[]" value="{{$result->id_salon}}" class="form-control" /></td>
                                    <td>
                                        <input type="text" name="ordering[]" value="{{$result->ordering_salon }}" class="form-control" style="width:50px !important" />
