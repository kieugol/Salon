...
<aside class="right-side">
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/adv/update"  accept-charset="uft8" role="form">
    <section class="content-header">
                    <h1>Adv_right<small>/ update</small></h1>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">                
                                            ...
                                            <!-- form start -->                
                                                ...
                                                <table class="table " >
                                                    <tr>
                                                            <td style="width:150px"><label>Thumbs</label></td>
                                                            <td>
                                                                <a href="#" data-toggle="modal" data-target=".gallery-img">
                                                                <img id="img-data" src="<?php echo Asset('/').'store/upload/images/'. $list_adv['image_adv_right'] ?>">
                                                                </a> <br />
                                                                <a href="#" id="img-product"  data-toggle="modal" data-target=".gallery-img"> Changes images</a>
                                                                <input type="hidden" id="txt_thumb" name="txt_thumb" value="<?php echo $list_adv['image_adv_right'] ?>"  >
                                                                <input type="hidden" id="txt_id" name="txt_id" value="<?php echo $list_adv['idAdvRight'] ?>" >
                                                            </td>                                                
                                                        </tr>
                                                         <tr>
                                                            <td><label >Title</label></td>
                                                            <td><input type="text" class="form-control" value="{{$list_adv['title_adv_right']}}" name="txt_title" id="txt_title" placeholder="Enter title"></td>                                                
                                                        </tr>
                                                        <tr>
                                                            <td><label >Block</label></td>
                                                            <td>
                                                                <select name="sl_block" id="sl_block" class="form-control">
                                                                        <option value="1" <?php if($list_adv['position_adv_right']==1) echo 'selected' ?> >block1 (header)</option>
                                                                        <option value="2" <?php if($list_adv['position_adv_right']==2) echo 'selected' ?> >block2 (slider)</option>
                                                                        <option value="3" <?php if($list_adv['position_adv_right']==3) echo 'selected' ?> >block3 (left)</option>
                                                                        <option value="4" <?php if($list_adv['position_adv_right']==4) echo 'selected' ?> >block4 (content-top)</option>
                                                                        <option value="5" <?php if($list_adv['position_adv_right']==5) echo 'selected' ?> >block5 (content-down)</option>
                                                                        <option value="6" <?php if($list_adv['position_adv_right']==6) echo 'selected' ?> >block6 (right)</option>
                                                                </select>
                                                            </td>                                                
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="sl_onpage" id="sl_onpage" class="form-control">
                                                                        <option <?php  if($list_adv['onpage_adv_right']=='links') echo 'selected="selected"'; ?> value="links">Links</option>
                                                                        <option <?php if($list_adv['onpage_adv_right']=='page') echo 'selected="selected"'; ?> value="page">Page</option>
                                                                </select>
                                                            </td>                                                
                                                        </tr>
                                                       <tr>
                                                            <td><label >Adv Url</label></td>
                                                            <td><input type="text" value="{{$list_adv['url_adv_right']}}" class="form-control" name="txt_url" id="txt_url" placeholder="Enter Url"></td>                                                
                                                        </tr>
                                                         <tr>
                                                            <td> <label >Sort </label></td>
                                                            <td> <input type="text" name="txt_sort" id="txt_sort" class="form-control" value="<?php echo $list_adv['ordering_adv_right']  ?>" > </td>
                                                        </tr>
                                                         <tr>
                                                            <td> <label >Status</label></td>
                                                            <td>
                                                                <input type="radio" name="rd_status" <?php if($list_adv['enable_adv_right'] == 1) echo 'checked="checked"'?>   value="1">&nbsp;On &nbsp;&nbsp;     
                                                                <input type="radio" name="rd_status" <?php if($list_adv['enable_adv_right'] == 0) echo 'checked="checked"'?>  value="0"> Off
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><label >Adv Description</label></td>
                                                            <td><textarea name="txt_des" id="txt_des">{{$list_adv['text_adv_right']}}</textarea></td>                                                
                                                        </tr>
