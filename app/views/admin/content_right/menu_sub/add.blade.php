...
<aside class="right-side">
     ...
     <form  id="productForm" method="post"  action="<?php echo Asset('/')?>administrator/menu/insert-sub" accept-charset="utf-8" role="form"   >             

                <!-- Content Header (Page header) -->

                <section class="content-header">             

                    <h1>Sub Menu<small>/ insert</small></h1>

                    <div style="text-align: right">

                        <button class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>

                        <a href="<?php echo Asset('/') ?>administrator/menu/sub" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i> Back</a>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <table class="table " >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><label >Menu Sub Title</label></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select selected="selected" name="sl_menusub" id="sl_menusub" class="form-control">
                                                                <option value="0">Menu Level1</option>
                                                                {{$combobox_menu;}}
                                                                </select>
                                                            </td>
                                                        </tr>
