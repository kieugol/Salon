...
<aside class="right-side">
     <form  id="productForm" method="post" accept-charset="utf-8" role="form" action="<?php echo Asset('/')?>administrator/articles/insert"     >             
                <!-- Content Header (Page header) -->
                <section class="content-header">             
                    <h1>Articles<small>/ insert</small></h1>
                                            ...
                                            <div class="box-body">                       
                                                <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control" name="txt_title"id="txt_title" placeholder="Enter name"></td>                                                
                                                         ...
                                                         <tr>
                                                            ...
                                                            <?php foreach ($list_articlesCat as $value) 
                                                                 {
                                                            ?>
                                                                    <option  value="<?php echo $value->idArticlesCategories ?>"><?php echo $value->name_articles_categories ?></option>
                                                            <?php
                                                                 }
                                                            ?>
                                                                </select>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="radio" name="rd_hits" checked="checked"  value="1">&nbsp;Yes &nbsp;&nbsp;  
                                                                <input type="radio" name="rd_hits"  value="0"> No
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><textarea class="form-control" id="txt_introtext" name="txt_introtext" placeholder="Introtext" rows="4"></textarea></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control" id="txt_related_articles" name="txt_related_articles" ></td>
                                                        </tr>
                                                        <tr>
