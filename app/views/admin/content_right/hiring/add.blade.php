...
<aside class="right-side">
     <form  id="productForm" method="post" accept-charset="utf-8" role="form" action="<?php echo Asset('/') ?>administrator/hiringad/insert"     >
                ...
                <section class="content-header">
                    ...
                    <div style="text-align: right">
                        ...
                        <a href="<?php echo Asset('/') ?>administrator/hiringad/home" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i> Cancel</a>
                    </div>
                </section>
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" value="" class="form-control" name="txt_title"id="txt_title" placeholder="Enter name"></td>                                                

                                    </tr>
                                    <tr>
                                        <td> <label >trạng thái</label></td>
                                        <td>
                                            <input type="radio" checked="checked"  name="rd_status" checked="checked"  value="1">&nbsp;On &nbsp;&nbsp;     
