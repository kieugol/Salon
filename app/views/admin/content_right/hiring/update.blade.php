...
<aside class="right-side">
   ...
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/hiringad/update"  accept-charset="uft8" role="form">
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                @foreach($list_salon as $salon)
                                                    <option <?php if ($salon->id_salon == $list_articles['id_salon']) {echo 'selected';}?> value="{{$salon->id_salon}}">{{$salon->name_salon}}({{$salon->name_province}})</option>
                                                @endforeach
                                                </select>
                                            </td>
                                        </tr>
