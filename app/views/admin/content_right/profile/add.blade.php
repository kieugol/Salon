...
<aside class="right-side">
     <form  id="productForm" method="post" accept-charset="utf-8" role="form" action="<?php echo Asset('/')?>administrator/profile/insert"  >             
                <!-- Content Header (Page header) -->
                <section class="content-header">             
                    <h1>Profile<small>/ insert</small></h1>
                                        ...
                                        <div class="box-body">                       
                                              <table class="table " >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><textarea class="form-control" name="txt_value"id="txt_value" ></textarea> </td>                                               
                                                        </tr>
                                                </table>  
                                        </div>                                             
                                    </div><!-- /.tab-pane -->
