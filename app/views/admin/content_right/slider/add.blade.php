...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/') ?>administrator/slider/insert" accept-charset="utf-8" role="form"   >
                                            ...
                                            <!-- form start -->
                                                ...
                                                <table class="table " >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control"  name="txt_url" id="txt_url" placeholder="Enter description"></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>Text hiển thị</label></td>
                                                            <td><input type="text" class="form-control"  name="txt_text1" id="txt_text1" placeholder="Enter description"></td>
                                                        </tr>

                                                        <!-- <tr>
                                                            <td> <label >Position </label></td>
                                                            <td>
                                                                <select name="sl_ordering" class="form-control" id="sl_ordering">
                                                                    <option selected="selected" value="1">Slider 1</option>
