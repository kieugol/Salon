...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/')?>administrator/products/insert" accept-charset="utf-8" role="form"   >             
                        ...
                        <div class="  col-md-12 col-lg-12">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class=""><a href="#tab_3" data-toggle="tab">Gallery Products</a></li>
                                </ul>
                                        ...
                                        <!-- form start -->                
                                            ...
                                            <table class="table " >
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @foreach($list_products_cat as $product_cat)
                                                             <option value="{{$product_cat->idProductsCategories}}">{{$product_cat->name_products_categories}}</option>
                                                            @endforeach
                                                            </select>
                                                        </td>                                                
                                                    </tr>
                                                        ...
                                                        <td>
                                                            <select class="form-control" id="sl_made" name="sl_made">
                                                                ...
                                                                @foreach($list_productsMade as $result)
                                                                    <option value="{{$result->idProductsMadein}}">{{$result->name_products_madein}}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="form-control" id="txt_size" class="txt_size" name="txt_size" placeholder="dung tích 100ml"> </td>
                                                    </tr>
                                                    <tr>
                                                        <td> <label >Price</label></td>
                                                        <td><input type="text" class="form-control" id="txt_price" class="txt_price" name="txt_price" placeholder="Price"></td>
                                                    </tr>
                                                     <tr>
                                                        <td><label >Sale (%) </label></td>
                                                        <td> <input type="text" class="form-control" value="0" name="txt_percent" id="txt_percent" > </td>
                                                    </tr>
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td> <textarea name="txt_short_des" id="txt_short_des" rows="5"></textarea></td>
                                                    </tr>
                                                    <tr>
