...
<aside class="right-side">
   <form id="productForm" method="post" action="<?php echo Asset('/') ?>administrator/productsCategories/update"  accept-charset="uft8" role="form">
    <section class="content-header">
                    <h1>Products Categories<small>/ update</small></h1>
                    <div style="text-align: right">
                        <button class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-floppy-save"></span> Save </button>
                        <a href="<?php echo Asset('/') ?>administrator/productsCategories/home" class="btn btn-danger btn-flat"><i class="fa fa-fw fa-mail-reply"></i>Back</a>
                    </div> 
    </section> <!-- Function header -->
    <section class="content">
      <div class="row"> 
      <h1><?php if(count($list_productsCat)< 1 ) echo 'khong co roi' ?></h1>            
                                ...
                                <table class="table " >
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img id="img-data" src="<?php echo Asset('/').'store/upload/images/'.$list_productsCat['thumb_products_categories'] ?>">
                                            </a> <br />
                                            <a href="#" id="img-product"  data-toggle="modal" data-target=".gallery-img"> Changes images</a>
                                            <input type="hidden" id="txt_thumb" name="txt_thumb" value="<?php echo $list_productsCat['thumb_products_categories'] ?>"  >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><label >Tên danh mục</label></td>
                                        <td><input type="text" value="<?php echo $list_productsCat['name_products_categories'] ?>" class="form-control" name="txt_name"id="txt_name" placeholder="Enter name">
                                             <input type="hidden" name="txt_id" value="<?php echo $list_productsCat['idProductsCategories'] ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> <label >thứ tự </label></td>
                                        <td> <input type="text" value="<?php echo $list_productsCat['ordering_products_categories'] ?>" class="form-control" name="txt_sort" id="txt_sort"> </td>
                                    </tr>
