...
<aside class="right-side">
     <form  id="productForm" method="post"  action="<?php echo Asset('/')?>administrator/productsCategories/insert" accept-charset="utf-8" role="form"   >             
                <!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>Products Categories<small>/ insert</small></h1>
                        ...
                        <div class="  col-md-12 col-lg-12">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class=""><a href="#upload" data-toggle="tab">Gallery</a></li>
                                </ul>
