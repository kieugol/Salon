                    ...
                    <!-- Salom -->
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                               ...
                               <li><a href="<?php echo Asset('/') ?>administrator/salon/home-auto-register"><i class="fa fa-angle-double-right"></i>Salon Chờ duyệt</a></li>
                    ...
                    @endif
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo Asset('/') ?>administrator/event/home-auto-register"><i class="fa fa-angle-double-right"></i>Sự Kiện chờ duyệt</a></li>
                       ...
                       <!-- Products -->
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo Asset('/') ?>administrator/articles/home"><i class="fa fa-angle-double-right"></i>Tin tức</a></li>
                                <li><a href="<?php echo Asset('/') ?>administrator/articlesCategories/home"><i class="fa fa-angle-double-right"></i>Danh mục</a></li>
                            </ul>
                        </li>
                       <!--  Articles -->
                         <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li>
									<a href="<?php echo Asset('/') ?>administrator/hiringad/home">
										<i class="fa fa-angle-double-right"></i> Tin đã duyệt
									</a>
								</li>
								<li>
									<a href="<?php echo Asset('/') ?>administrator/hiringad/home-waiting">
										<i class="fa fa-angle-double-right"></i>Tin chờ Duyệt
									</a>
								</li>
                            </ul>
                        </li>
